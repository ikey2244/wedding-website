    ...
    >
      ...
      <p className="text-center text-gray-600 font-body">We hope to see you there!</p>
        ...
        <div className="mb-4">
          ...
          <input required style={{fontFamily: 'poppins'}} className="text-body shadow appearance-none border rounded w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required type="text" id="fullName" placeholder="John Smith" name="fullName" onChange={handleChange} />
        </div>

        <div className="mb-4">
          <label className="block font-body text-gray-700 text-sm font-bold mb-2" htmlFor="email">Email</label>
          <input required style={{fontFamily: 'poppins'}} className="text-body shadow appearance-none border rounded w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required type="email" id="email" placeholder="example@example.com" name="email" onChange={handleChange}  />
        </div>

        <div className="mb-4">
          <label className="block font-body text-gray-700 text-sm font-bold mb-2" for="grid-state">
            Response 
          </label>
          <div className="relative">
            <select required name="response" onChange={handleChange} className="text-body shadow appearance-none border rounded w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline bg-white" id="grid-state">
